 ...
 * @{
 */
#define ADC_CHANNEL_IN0         0U  /**< @brief Internal analog input 0.    */
...
#define ADC_CHANNEL_IN18        18U /**< @brief Internal analog input 18.   */
#define ADC_CHANNEL_IN19        19U /**< @brief Internal analog input 19.   */

#define ADC_CHANNEL_VREFINT     ADC_CHANNEL_IN0
#define ADC_CHANNEL_VBAT        ADC_CHANNEL_IN18
#define ADC_CHANNEL_SENSOR      ADC_CHANNEL_IN19
/** @} */
 ...
 * @{
 */
#define ADC_SMPR_SMP_5          0U  /**< @brief 5 cycles sampling time.     */
#define ADC_SMPR_SMP_6          1U  /**< @brief 6 cycles sampling time.     */
#define ADC_SMPR_SMP_12         2U  /**< @brief 12 cycles sampling time.    */
#define ADC_SMPR_SMP_20         3U  /**< @brief 20 cycles sampling time.    */
#define ADC_SMPR_SMP_36         4U  /**< @brief 36 cycles sampling time.    */
#define ADC_SMPR_SMP_68         5U  /**< @brief 68 cycles sampling time.    */
#define ADC_SMPR_SMP_391        6U  /**< @brief 391 cycles sampling time.   */
#define ADC_SMPR_SMP_814        7U  /**< @brief 814 cycles sampling time.   */
/** @} */
...
#define ADC_CFGR1_DMNGT_MDF             (2U << ADC_CFGR1_DMNGT_Pos)
...
#define ADC_CFGR1_RES_14BITS            (0U << ADC_CFGR1_RES_Pos)
#define ADC_CFGR1_RES_12BITS            (1U << ADC_CFGR1_RES_Pos)
#define ADC_CFGR1_RES_10BITS            (2U << ADC_CFGR1_RES_Pos)
#define ADC_CFGR1_RES_8BITS             (3U << ADC_CFGR1_RES_Pos)
 ...
 * @{
 */
#define ADC_CCR_PRESC_DIV1             (0U << ADC_CCR_PRESC_Pos)
...
#if STM32_HAS_ADC2 || defined(__DOXYGEN__)
#define ADC_CCR_DUAL_FIELD(n)           ((uint32_t)(n) << ADC_CCR_DUAL_Pos)
#define ADC_CCR_DUAL_INDEPENDENT        ADC_CCR_DUAL_FIELD(0U)
#define ADC_CCR_DUAL_REG_SIM_INJ_SIM    ADC_CCR_DUAL_FIELD(1U)
#define ADC_CCR_DUAL_REG_SIM_INJ_ALT    ADC_CCR_DUAL_FIELD(2U)
#define ADC_CCR_DUAL_REG_INT_INJ_SIM    ADC_CCR_DUAL_FIELD(3U)
#define ADC_CCR_DUAL_INJ_SIMULT         ADC_CCR_DUAL_FIELD(5U)
#define ADC_CCR_DUAL_REG_SIMULT         ADC_CCR_DUAL_FIELD(6U)
#define ADC_CCR_DUAL_REG_INTERL         ADC_CCR_DUAL_FIELD(7U)
#define ADC_CCR_DUAL_INJ_ALTERNATE      ADC_CCR_DUAL_FIELD(9U)
 ...
 * @note    10, 12 and 14 bits sampling modes must not be used when this
 *          option is enabled.
 */
...
#error "ADCv8 only supports STM32U5 devices"
#endif
...
/* Units checks.*/
#if (STM32_ADC_DUAL_MODE != TRUE) && (STM32_ADC_DUAL_MODE != FALSE)
#error "Invalid STM32_ADC_DUAL_MODE value"
#endif

#if (STM32_ADC_COMPACT_SAMPLES != TRUE) &&                            \
    (STM32_ADC_COMPACT_SAMPLES != FALSE)
#error "Invalid STM32_ADC_COMPACT_SAMPLES value"
#endif
...
#if (STM32_PWR_SVMCR & PWR_SVMCR_ASV) == 0U
#error "ADC12 requires PWR_SVMCR_ASV in STM32_PWR_SVMCR"
#endif
...
/* DMA request checks.*/
#if STM32_ADC_USE_ADC1 && !defined(STM32_DMA3_REQ_ADC1)
#error "ADC1 DMA3 request not defined"
#endif

#if STM32_ADC_USE_ADC2 && !defined(STM32_DMA3_REQ_ADC2)
#error "ADC2 DMA3 request not defined"
#endif
...
#if STM32_ADC_ADC12_PRESC == ADC_CCR_PRESC_DIV1
#define STM32_ADC12_PRESC_DIVISOR         1U
#elif STM32_ADC_ADC12_PRESC == ADC_CCR_PRESC_DIV2
#define STM32_ADC12_PRESC_DIVISOR         2U
#elif STM32_ADC_ADC12_PRESC == ADC_CCR_PRESC_DIV4
#define STM32_ADC12_PRESC_DIVISOR         4U
#elif STM32_ADC_ADC12_PRESC == ADC_CCR_PRESC_DIV6
#define STM32_ADC12_PRESC_DIVISOR         6U
#elif STM32_ADC_ADC12_PRESC == ADC_CCR_PRESC_DIV8
#define STM32_ADC12_PRESC_DIVISOR         8U
#elif STM32_ADC_ADC12_PRESC == ADC_CCR_PRESC_DIV10
#define STM32_ADC12_PRESC_DIVISOR         10U
#elif STM32_ADC_ADC12_PRESC == ADC_CCR_PRESC_DIV12
#define STM32_ADC12_PRESC_DIVISOR         12U
#elif STM32_ADC_ADC12_PRESC == ADC_CCR_PRESC_DIV16
#define STM32_ADC12_PRESC_DIVISOR         16U
#elif STM32_ADC_ADC12_PRESC == ADC_CCR_PRESC_DIV32
#define STM32_ADC12_PRESC_DIVISOR         32U
#elif STM32_ADC_ADC12_PRESC == ADC_CCR_PRESC_DIV64
#define STM32_ADC12_PRESC_DIVISOR         64U
#elif STM32_ADC_ADC12_PRESC == ADC_CCR_PRESC_DIV128
#define STM32_ADC12_PRESC_DIVISOR         128U
#elif STM32_ADC_ADC12_PRESC == ADC_CCR_PRESC_DIV256
#define STM32_ADC12_PRESC_DIVISOR         256U
#else
#error "Invalid STM32_ADC_ADC12_PRESC value"
#endif

#define STM32_ADC12_FREQ                  (STM32_ADCDAC_FREQ /              \
                                           STM32_ADC12_PRESC_DIVISOR)
#define STM32_ADC12_CLOCK                 (STM32_ADCDAC_CLOCK /             \
                                           STM32_ADC12_PRESC_DIVISOR)

#if STM32_ADC12_FREQ > STM32_ADCCLK_MAX
...
#define adc_lld_config_fields                                               \
  ...
  uint32_t                          dmactr2;                                \
  /* Master ADC differential channels selection.*/                         \
  uint32_t                          difsel;                                 \
  /* Slave ADC differential channels selection.*/                          \
  uint32_t                          sdifsel;
#else
#define adc_lld_config_fields                                               \
  /* DMA extra CTR1 settings.*/                                             \
  ...
  /* DMA extra CTR2 settings.*/                                             \
  uint32_t                          dmactr2;                                \
  /* ADC differential channels selection.*/                                \
  uint32_t                          difsel;
#endif
...
#define adc_lld_configuration_group_fields                                  \
  ...
  uint32_t                          pcsel;                                  \
  /* ADC LTR1/HTR1 initialization data, including AWDFILT in HTR1.*/        \
  uint32_t                          ltr1;                                   \
  uint32_t                          htr1;                                   \
  /* ADC LTR2/HTR2 initialization data.*/                                   \
  uint32_t                          ltr2;                                   \
  uint32_t                          htr2;                                   \
  /* ADC LTR3/HTR3 initialization data.*/                                   \
  uint32_t                          ltr3;                                   \
  uint32_t                          htr3;                                   \
 ...
 * @{
 */
#define ADC_CFGR1_AWD1_N(n)     ((n) << 26U)/**< @brief AWD1 channel number */
