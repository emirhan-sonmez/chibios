 ...
 * @brief   STM32G4xx generated clock tree HAL header.
 *
 * @addtogroup HAL
 * @{
 */
...
#if defined(STM32G431xx) && !defined(__STM32G431_XMCUCONF__)
#error "Using a wrong xmcuconf.h file, __STM32G431_XMCUCONF__ not defined"

#elif defined(STM32G441xx) && !defined(__STM32G441_XMCUCONF__)
#error "Using a wrong xmcuconf.h file, __STM32G441_XMCUCONF__ not defined"

#elif defined(STM32G471xx) && !defined(__STM32G471_XMCUCONF__)
#error "Using a wrong xmcuconf.h file, __STM32G471_XMCUCONF__ not defined"

#elif defined(STM32G473xx) && !defined(__STM32G473_XMCUCONF__)
#error "Using a wrong xmcuconf.h file, __STM32G473_XMCUCONF__ not defined"

#elif defined(STM32G483xx) && !defined(__STM32G483_XMCUCONF__)
#error "Using a wrong xmcuconf.h file, __STM32G483_XMCUCONF__ not defined"

#elif defined(STM32G474xx) && !defined(__STM32G474_XMCUCONF__)
#error "Using a wrong xmcuconf.h file, __STM32G474_XMCUCONF__ not defined"

#elif defined(STM32G484xx) && !defined(__STM32G484_XMCUCONF__)
#error "Using a wrong xmcuconf.h file, __STM32G484_XMCUCONF__ not defined"

#elif defined(STM32GBK1CB) && !defined(__STM32GBK1CB_XMCUCONF__)
#error "Using a wrong xmcuconf.h file, __STM32GBK1CB_XMCUCONF__ not defined"

#elif defined(STM32G491xx) && !defined(__STM32G491_XMCUCONF__)
#error "Using a wrong xmcuconf.h file, __STM32G491_XMCUCONF__ not defined"
#endif
