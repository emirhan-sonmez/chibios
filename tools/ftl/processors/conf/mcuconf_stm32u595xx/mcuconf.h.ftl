...
#define STM32_CFG_DSIPHYCLK                 ${doc.STM32_CFG_DSIPHYCLK!"0U"}
...
#define STM32_CFG_DPHY_VALUE                ${doc.STM32_CFG_DPHY_VALUE!"8"}
 ...
 */
#define STM32_CFG_PLL1P_CLOCK_MODE          ${doc.STM32_CFG_PLL1P_CLOCK_MODE!"STM32_CLOCK_AUTO"}
#define STM32_CFG_PLL1Q_CLOCK_MODE          ${doc.STM32_CFG_PLL1Q_CLOCK_MODE!"STM32_CLOCK_AUTO"}
#define STM32_CFG_PLL1R_CLOCK_MODE          ${doc.STM32_CFG_PLL1R_CLOCK_MODE!"STM32_CLOCK_AUTO"}
#define STM32_CFG_PLL2P_CLOCK_MODE          ${doc.STM32_CFG_PLL2P_CLOCK_MODE!"STM32_CLOCK_AUTO"}
#define STM32_CFG_PLL2Q_CLOCK_MODE          ${doc.STM32_CFG_PLL2Q_CLOCK_MODE!"STM32_CLOCK_AUTO"}
#define STM32_CFG_PLL2R_CLOCK_MODE          ${doc.STM32_CFG_PLL2R_CLOCK_MODE!"STM32_CLOCK_AUTO"}
#define STM32_CFG_PLL3P_CLOCK_MODE          ${doc.STM32_CFG_PLL3P_CLOCK_MODE!"STM32_CLOCK_AUTO"}
#define STM32_CFG_PLL3Q_CLOCK_MODE          ${doc.STM32_CFG_PLL3Q_CLOCK_MODE!"STM32_CLOCK_AUTO"}
#define STM32_CFG_PLL3R_CLOCK_MODE          ${doc.STM32_CFG_PLL3R_CLOCK_MODE!"STM32_CLOCK_AUTO"}
...
#define STM32_CFG_I2C5_CLOCK_MODE           ${doc.STM32_CFG_I2C5_CLOCK_MODE!"STM32_CLOCK_AUTO"}
#define STM32_CFG_I2C6_CLOCK_MODE           ${doc.STM32_CFG_I2C6_CLOCK_MODE!"STM32_CLOCK_AUTO"}
...
#define STM32_CFG_SYSTICK_CLOCK_MODE        ${doc.STM32_CFG_SYSTICK_CLOCK_MODE!"STM32_CLOCK_AUTO"}
#define STM32_CFG_OTGHS_CLOCK_MODE          ${doc.STM32_CFG_OTGHS_CLOCK_MODE!"STM32_CLOCK_AUTO"}
#define STM32_CFG_SDMMC1_CLOCK_MODE         ${doc.STM32_CFG_SDMMC1_CLOCK_MODE!"STM32_CLOCK_AUTO"}
#define STM32_CFG_SDMMC2_CLOCK_MODE         ${doc.STM32_CFG_SDMMC2_CLOCK_MODE!"STM32_CLOCK_AUTO"}
#define STM32_CFG_OCTOSPI_CLOCK_MODE        ${doc.STM32_CFG_OCTOSPI_CLOCK_MODE!"STM32_CLOCK_AUTO"}
#define STM32_CFG_HSPI1_CLOCK_MODE          ${doc.STM32_CFG_HSPI1_CLOCK_MODE!"STM32_CLOCK_AUTO"}
#define STM32_CFG_DSI_CLOCK_MODE            ${doc.STM32_CFG_DSI_CLOCK_MODE!"STM32_CLOCK_AUTO"}
#define STM32_CFG_LTDC_CLOCK_MODE           ${doc.STM32_CFG_LTDC_CLOCK_MODE!"STM32_CLOCK_AUTO"}
#define STM32_CFG_SAES_CLOCK_MODE           ${doc.STM32_CFG_SAES_CLOCK_MODE!"STM32_CLOCK_AUTO"}
...
#define STM32_CFG_SAI2_CLOCK_MODE           ${doc.STM32_CFG_SAI2_CLOCK_MODE!"STM32_CLOCK_AUTO"}
#define STM32_CFG_MDF1_CLOCK_MODE           ${doc.STM32_CFG_MDF1_CLOCK_MODE!"STM32_CLOCK_AUTO"}
...
#define STM32_CFG_IWDG_CLOCK_MODE           ${doc.STM32_CFG_IWDG_CLOCK_MODE!"STM32_CLOCK_AUTO"}
...
#define STM32_CFG_USART6_SEL                ${doc.STM32_CFG_USART6_SEL!"RCC_CCIPR2_USART6SEL_PCLK1"}
...
#define STM32_CFG_I2C5_SEL                  ${doc.STM32_CFG_I2C5_SEL!"RCC_CCIPR2_I2C5SEL_PCLK1"}
#define STM32_CFG_I2C6_SEL                  ${doc.STM32_CFG_I2C6_SEL!"RCC_CCIPR2_I2C6SEL_PCLK1"}
...
#define STM32_CFG_HSPI1_SEL                 ${doc.STM32_CFG_HSPI1_SEL!"RCC_CCIPR2_HSPISEL_SYSCLK"}
#define STM32_CFG_USBPHYC_SEL               ${doc.STM32_CFG_USBPHYC_SEL!"RCC_CCIPR2_USBPHYCSEL_HSE"}
#define STM32_CFG_DSI_SEL                   ${doc.STM32_CFG_DSI_SEL!"RCC_CCIPR2_DSIHOSTSEL_PLL3P"}
#define STM32_CFG_LTDC_SEL                  ${doc.STM32_CFG_LTDC_SEL!"RCC_CCIPR2_LTDCSEL_PLL3R"}
#define STM32_CFG_SAES_SEL                  ${doc.STM32_CFG_SAES_SEL!"RCC_CCIPR2_SAESSEL_SHSI"}
...
#define STM32_SERIAL_USART6_IN_BUF_SIZE     ${doc.STM32_SERIAL_USART6_IN_BUF_SIZE!"SERIAL_BUFFERS_SIZE"}
#define STM32_SERIAL_USART6_OUT_BUF_SIZE    ${doc.STM32_SERIAL_USART6_OUT_BUF_SIZE!"SERIAL_BUFFERS_SIZE"}
