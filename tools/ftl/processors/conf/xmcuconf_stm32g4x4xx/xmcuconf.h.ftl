 ...
 * Clock settings.
 */
#define STM32_CFG_PWR_VOS                   ${doc.STM32_CFG_PWR_VOS!"PWR_CR1_VOS_RANGE1"}
#define STM32_CFG_PWR_BOOST                 ${doc.STM32_CFG_PWR_BOOST!(doc.STM32_PWR_BOOST!"TRUE")}
#define STM32_CFG_HSI16_ENABLE              ${doc.STM32_CFG_HSI16_ENABLE!(doc.STM32_HSI16_ENABLED!"TRUE")}
#define STM32_CFG_HSI48_ENABLE              ${doc.STM32_CFG_HSI48_ENABLE!(doc.STM32_HSI48_ENABLED!"TRUE")}
#define STM32_CFG_HSE_ENABLE                ${doc.STM32_CFG_HSE_ENABLE!(doc.STM32_HSE_ENABLED!"TRUE")}
...
#define STM32_CFG_SYSCLK_SEL                ${doc.STM32_CFG_SYSCLK_SEL!"RCC_CFGR_SW_PLL"}
#define STM32_CFG_PLLIN_SEL                 ${doc.STM32_CFG_PLLIN_SEL!"RCC_PLLCFGR_PLLSRC_HSE"}
#define STM32_CFG_PLLREF_VALUE              ${doc.STM32_CFG_PLLREF_VALUE!"6"}
#define STM32_CFG_PLLVCO_VALUE              ${doc.STM32_CFG_PLLVCO_VALUE!"85"}
#define STM32_CFG_PLLP_VALUE                ${doc.STM32_CFG_PLLP_VALUE!"7"}
#define STM32_CFG_PLLQ_VALUE                ${doc.STM32_CFG_PLLQ_VALUE!"8"}
#define STM32_CFG_PLLR_VALUE                ${doc.STM32_CFG_PLLR_VALUE!"2"}
#define STM32_CFG_HCLK_VALUE                ${doc.STM32_CFG_HCLK_VALUE!"1"}
#define STM32_CFG_PCLK1_VALUE               ${doc.STM32_CFG_PCLK1_VALUE!"2"}
#define STM32_CFG_PCLK2_VALUE               ${doc.STM32_CFG_PCLK2_VALUE!"1"}
#define STM32_CFG_MCODIV_SEL                ${doc.STM32_CFG_MCODIV_SEL!"RCC_CFGR_MCOSEL_NOCLOCK"}
 ...
 */
#define STM32_CFG_PLLP_CLOCK_MODE           ${doc.STM32_CFG_PLLP_CLOCK_MODE!"STM32_CLOCK_AUTO"}
#define STM32_CFG_PLLQ_CLOCK_MODE           ${doc.STM32_CFG_PLLQ_CLOCK_MODE!"STM32_CLOCK_AUTO"}
#define STM32_CFG_PLLR_CLOCK_MODE           ${doc.STM32_CFG_PLLR_CLOCK_MODE!"STM32_CLOCK_AUTO"}
#define STM32_CFG_RTC_CLOCK_MODE            ${doc.STM32_CFG_RTC_CLOCK_MODE!"STM32_CLOCK_AUTO"}
...
#define STM32_CFG_I2C4_CLOCK_MODE           ${doc.STM32_CFG_I2C4_CLOCK_MODE!"STM32_CLOCK_AUTO"}
...
#define STM32_CFG_I2S23_CLOCK_MODE          ${doc.STM32_CFG_I2S23_CLOCK_MODE!"STM32_CLOCK_AUTO"}
#define STM32_CFG_FDCAN_CLOCK_MODE          ${doc.STM32_CFG_FDCAN_CLOCK_MODE!"STM32_CLOCK_AUTO"}
#define STM32_CFG_ADC12_CLOCK_MODE          ${doc.STM32_CFG_ADC12_CLOCK_MODE!"STM32_CLOCK_AUTO"}
#define STM32_CFG_ADC345_CLOCK_MODE         ${doc.STM32_CFG_ADC345_CLOCK_MODE!"STM32_CLOCK_AUTO"}
#define STM32_CFG_QSPI_CLOCK_MODE           ${doc.STM32_CFG_QSPI_CLOCK_MODE!"STM32_CLOCK_AUTO"}
 ...
 */
#define STM32_CFG_USART1_SEL                ${doc.STM32_CFG_USART1_SEL!"RCC_CCIPR_USART1SEL_SYSCLK"}
#define STM32_CFG_USART2_SEL                ${doc.STM32_CFG_USART2_SEL!"RCC_CCIPR_USART2SEL_SYSCLK"}
#define STM32_CFG_USART3_SEL                ${doc.STM32_CFG_USART3_SEL!"RCC_CCIPR_USART3SEL_SYSCLK"}
#define STM32_CFG_UART4_SEL                 ${doc.STM32_CFG_UART4_SEL!"RCC_CCIPR_UART4SEL_SYSCLK"}
#define STM32_CFG_UART5_SEL                 ${doc.STM32_CFG_UART5_SEL!"RCC_CCIPR_UART5SEL_SYSCLK"}
#define STM32_CFG_LPUART1_SEL               ${doc.STM32_CFG_LPUART1_SEL!"RCC_CCIPR_LPUART1SEL_PCLK1"}
#define STM32_CFG_I2C1_SEL                  ${doc.STM32_CFG_I2C1_SEL!"RCC_CCIPR_I2C1SEL_PCLK1"}
#define STM32_CFG_I2C2_SEL                  ${doc.STM32_CFG_I2C2_SEL!"RCC_CCIPR_I2C2SEL_PCLK1"}
#define STM32_CFG_I2C3_SEL                  ${doc.STM32_CFG_I2C3_SEL!"RCC_CCIPR_I2C3SEL_PCLK1"}
#define STM32_CFG_I2C4_SEL                  ${doc.STM32_CFG_I2C4_SEL!"RCC_CCIPR2_I2C4SEL_PCLK1"}
#define STM32_CFG_LPTIM1_SEL                ${doc.STM32_CFG_LPTIM1_SEL!"RCC_CCIPR_LPTIM1SEL_PCLK1"}
#define STM32_CFG_SAI1_SEL                  ${doc.STM32_CFG_SAI1_SEL!"RCC_CCIPR_SAI1SEL_SYSCLK"}
#define STM32_CFG_I2S23_SEL                 ${doc.STM32_CFG_I2S23_SEL!"RCC_CCIPR_I2S23SEL_SYSCLK"}
#define STM32_CFG_FDCAN_SEL                 ${doc.STM32_CFG_FDCAN_SEL!"RCC_CCIPR_FDCANSEL_HSE"}
#define STM32_CFG_CLK48_SEL                 ${doc.STM32_CFG_CLK48_SEL!"RCC_CCIPR_CLK48SEL_HSI48"}
#define STM32_CFG_ADC12_SEL                 ${doc.STM32_CFG_ADC12_SEL!"RCC_CCIPR_ADC12SEL_PLLPCLK"}
#define STM32_CFG_ADC345_SEL                ${doc.STM32_CFG_ADC345_SEL!"RCC_CCIPR_ADC345SEL_PLLPCLK"}
#define STM32_CFG_QSPI_SEL                  ${doc.STM32_CFG_QSPI_SEL!"RCC_CCIPR2_QSPISEL_SYSCLK"}
#define STM32_CFG_RTC_SEL                   ${doc.STM32_CFG_RTC_SEL!((doc.STM32_RTCSEL!"STM32_RTCSEL_NOCLOCK") == "STM32_RTCSEL_LSE")?then("RCC_BDCR_RTCSEL_LSE", "RCC_BDCR_RTCSEL_NOCLOCK")}
