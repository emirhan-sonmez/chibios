...
#define STM32_CFG_CLOCK_DYNAMIC             ${doc.STM32_CFG_CLOCK_DYNAMIC!(doc.STM32_CLOCK_DYNAMIC!"FALSE")}
 ...
 * Clock settings.
 */
#define STM32_CFG_PWR_VOSR                  ${doc.STM32_CFG_PWR_VOSR!(doc.STM32_PWR_VOSR!"PWR_VOSR_RANGE1")}
#define STM32_CFG_MSIRC0_MODE               ${doc.STM32_CFG_MSIRC0_MODE!(doc.STM32_MSIRC0_MODE!"RCC_MSIRC0_PLL_LSE")}
#define STM32_CFG_MSIRC1_MODE               ${doc.STM32_CFG_MSIRC1_MODE!(doc.STM32_MSIRC1_MODE!"RCC_MSIRC1_FREE")}
#define STM32_CFG_MSIPLL1N_VALUE            ${doc.STM32_CFG_MSIPLL1N_VALUE!(doc.STM32_MSIPLL1N_VALUE!"0")}
#define STM32_CFG_AUDIOCLK                  ${doc.STM32_CFG_AUDIOCLK!"0U"}
#define STM32_CFG_MSIS_SRCDIV               ${doc.STM32_CFG_MSIS_SRCDIV!(doc.STM32_MSIS_SRCDIV!"RCC_ICSCR1_MSIS_IRC0_DIV1")}
#define STM32_CFG_MSIK_SRCDIV               ${doc.STM32_CFG_MSIK_SRCDIV!(doc.STM32_MSIK_SRCDIV!"RCC_ICSCR1_MSIK_IRC0_DIV1")}
#define STM32_CFG_STOPWUCK                  ${doc.STM32_CFG_STOPWUCK!(doc.STM32_STOPWUCK!"RCC_CFGR1_STOPWUCK_MSIS")}
#define STM32_CFG_STOPKERWUCK               ${doc.STM32_CFG_STOPKERWUCK!(doc.STM32_STOPKERWUCK!"RCC_CFGR1_STOPKERWUCK_MSIK")}
#define STM32_CFG_MSIBIAS                   ${doc.STM32_CFG_MSIBIAS!(doc.STM32_MSIBIAS!"RCC_ICSCR1_MSIBIAS_CONTINUOUS")}
#define STM32_CFG_TIMICSEL                  ${doc.STM32_CFG_TIMICSEL!(doc.STM32_TIMICSEL!"RCC_CCIPR1_TIMICSEL_NOCLOCK")}
#define STM32_CFG_HSI16_ENABLE              ${doc.STM32_CFG_HSI16_ENABLE!(doc.STM32_HSI16_ENABLED!"FALSE")}
#define STM32_CFG_HSI48_ENABLE              ${doc.STM32_CFG_HSI48_ENABLE!(doc.STM32_HSI48_ENABLED!"FALSE")}
#define STM32_CFG_HSE_ENABLE                ${doc.STM32_CFG_HSE_ENABLE!(doc.STM32_HSE_ENABLED!"FALSE")}
#define STM32_CFG_LSE_ENABLE                ${doc.STM32_CFG_LSE_ENABLE!(doc.STM32_LSE_ENABLED!"TRUE")}
#define STM32_CFG_LSI_ENABLE                ${doc.STM32_CFG_LSI_ENABLE!(doc.STM32_LSI_ENABLED!"FALSE")}
#define STM32_CFG_SYSCLK_SEL                ${doc.STM32_CFG_SYSCLK_SEL!(doc.STM32_SW!"RCC_CFGR1_SW_MSIS")}
...
#define STM32_CFG_MCO1DIV_SEL               ${doc.STM32_CFG_MCO1DIV_SEL!(doc.STM32_MCO1SEL!"RCC_CFGR1_MCO1SEL_OFF")}
#define STM32_CFG_MCO1_VALUE                ${doc.STM32_CFG_MCO1_VALUE!(doc.STM32_MCO1PRE_VALUE!"1")}
#define STM32_CFG_MCO2DIV_SEL               ${doc.STM32_CFG_MCO2DIV_SEL!(doc.STM32_MCO2SEL!"RCC_CFGR1_MCO2SEL_OFF")}
#define STM32_CFG_MCO2_VALUE                ${doc.STM32_CFG_MCO2_VALUE!(doc.STM32_MCO2PRE_VALUE!"1")}
#define STM32_CFG_RTC_SEL                   ${doc.STM32_CFG_RTC_SEL!(doc.STM32_RTCSEL!"RCC_BDCR_RTCSEL_NOCLOCK")}
#define STM32_CFG_LSCO_SEL                  ${doc.STM32_CFG_LSCO_SEL!(doc.STM32_LSCOSEL!"RCC_BDCR_LSCOSEL_NOCLOCK")}
...
#define STM32_CFG_LPTIM2_CLOCK_MODE         ${doc.STM32_CFG_LPTIM2_CLOCK_MODE!"STM32_CLOCK_AUTO"}
#define STM32_CFG_LPTIM34_CLOCK_MODE        ${doc.STM32_CFG_LPTIM34_CLOCK_MODE!"STM32_CLOCK_AUTO"}
...
#define STM32_CFG_OCTOSPI_CLOCK_MODE        ${doc.STM32_CFG_OCTOSPI_CLOCK_MODE!"STM32_CLOCK_AUTO"}
#define STM32_CFG_USB_CLOCK_MODE            ${doc.STM32_CFG_USB_CLOCK_MODE!"STM32_CLOCK_AUTO"}
#define STM32_CFG_SDMMC1_CLOCK_MODE         ${doc.STM32_CFG_SDMMC1_CLOCK_MODE!"STM32_CLOCK_AUTO"}
...
#define STM32_CFG_I2C3_CLOCK_MODE           ${doc.STM32_CFG_I2C3_CLOCK_MODE!"STM32_CLOCK_AUTO"}
#define STM32_CFG_I3C1_CLOCK_MODE           ${doc.STM32_CFG_I3C1_CLOCK_MODE!"STM32_CLOCK_AUTO"}
#define STM32_CFG_I3C2_CLOCK_MODE           ${doc.STM32_CFG_I3C2_CLOCK_MODE!"STM32_CLOCK_AUTO"}
...
#define STM32_CFG_FDCAN1_CLOCK_MODE         ${doc.STM32_CFG_FDCAN1_CLOCK_MODE!"STM32_CLOCK_AUTO"}
#define STM32_CFG_SAI1_CLOCK_MODE           ${doc.STM32_CFG_SAI1_CLOCK_MODE!"STM32_CLOCK_AUTO"}
#define STM32_CFG_ADF1_CLOCK_MODE           ${doc.STM32_CFG_ADF1_CLOCK_MODE!"STM32_CLOCK_AUTO"}

/*
 * Peripherals clock sources.
 */
#define STM32_CFG_USART1_SEL                ${doc.STM32_CFG_USART1_SEL!(doc.STM32_USART1SEL!"RCC_CCIPR1_USART1SEL_PCLK2")}
#define STM32_CFG_USART3_SEL                ${doc.STM32_CFG_USART3_SEL!(doc.STM32_USART3SEL!"RCC_CCIPR1_USART3SEL_PCLK1")}
#define STM32_CFG_UART4_SEL                 ${doc.STM32_CFG_UART4_SEL!(doc.STM32_UART4SEL!"RCC_CCIPR1_UART4SEL_PCLK1")}
#define STM32_CFG_UART5_SEL                 ${doc.STM32_CFG_UART5_SEL!(doc.STM32_UART5SEL!"RCC_CCIPR1_UART5SEL_PCLK1")}
#define STM32_CFG_LPUART1_SEL               ${doc.STM32_CFG_LPUART1_SEL!(doc.STM32_LPUART1SEL!"RCC_CCIPR3_LPUART1SEL_PCLK3")}
#define STM32_CFG_LPTIM1_SEL                ${doc.STM32_CFG_LPTIM1_SEL!(doc.STM32_LPTIM1SEL!"RCC_CCIPR3_LPTIM1SEL_MSIK")}
#define STM32_CFG_LPTIM2_SEL                ${doc.STM32_CFG_LPTIM2_SEL!(doc.STM32_LPTIM2SEL!"RCC_CCIPR1_LPTIM2SEL_PCLK1")}
#define STM32_CFG_LPTIM34_SEL               ${doc.STM32_CFG_LPTIM34_SEL!(doc.STM32_LPTIM34SEL!"RCC_CCIPR3_LPTIM34SEL_MSIK")}
#define STM32_CFG_SPI1_SEL                  ${doc.STM32_CFG_SPI1_SEL!(doc.STM32_SPI1SEL!"RCC_CCIPR1_SPI1SEL_PCLK2")}
#define STM32_CFG_SPI2_SEL                  ${doc.STM32_CFG_SPI2_SEL!(doc.STM32_SPI2SEL!"RCC_CCIPR1_SPI2SEL_PCLK1")}
#define STM32_CFG_SPI3_SEL                  ${doc.STM32_CFG_SPI3_SEL!(doc.STM32_SPI3SEL!"RCC_CCIPR2_SPI3SEL_PCLK1")}
#define STM32_CFG_OCTOSPI_SEL               ${doc.STM32_CFG_OCTOSPI_SEL!(doc.STM32_OCTOSPISEL!"RCC_CCIPR2_OCTOSPISEL_SYSCLK")}
#define STM32_CFG_SYSTICK_SEL               ${doc.STM32_CFG_SYSTICK_SEL!(doc.STM32_SYSTICKSEL!"RCC_CCIPR1_SYSTICKSEL_HCLKDIV8")}
#define STM32_CFG_ICLK_SEL                  ${doc.STM32_CFG_ICLK_SEL!(doc.STM32_ICLKSEL!"RCC_CCIPR1_ICLKSEL_SYSCLK")}
#define STM32_CFG_USB_SEL                   ${doc.STM32_CFG_USB_SEL!(doc.STM32_USB1SEL!"RCC_CCIPR1_USB1SEL_ICLKDIV2")}
#define STM32_CFG_I2C1_SEL                  ${doc.STM32_CFG_I2C1_SEL!(doc.STM32_I2C1SEL!"RCC_CCIPR1_I2C1SEL_PCLK1")}
#define STM32_CFG_I2C2_SEL                  ${doc.STM32_CFG_I2C2_SEL!(doc.STM32_I2C2SEL!"RCC_CCIPR1_I2C2SEL_PCLK1")}
#define STM32_CFG_I2C3_SEL                  ${doc.STM32_CFG_I2C3_SEL!(doc.STM32_I2C3SEL!"RCC_CCIPR3_I2C3SEL_PCLK3")}
#define STM32_CFG_I3C1_SEL                  ${doc.STM32_CFG_I3C1_SEL!(doc.STM32_I3C1SEL!"RCC_CCIPR1_I3C1SEL_PCLK1")}
#define STM32_CFG_I3C2_SEL                  ${doc.STM32_CFG_I3C2_SEL!(doc.STM32_I3C2SEL!"RCC_CCIPR1_I3C2SEL_PCLK2")}
#define STM32_CFG_ADCDACICLK_SEL            ${doc.STM32_CFG_ADCDACICLK_SEL!(doc.STM32_ADCDACSEL!"RCC_CCIPR2_ADCDACSEL_HCLK")}
#define STM32_CFG_ADCDACPRE_VALUE           ${doc.STM32_CFG_ADCDACPRE_VALUE!"1"}
#define STM32_CFG_DAC1SH_SEL                ${doc.STM32_CFG_DAC1SH_SEL!(doc.STM32_DAC1SHSEL!"RCC_CCIPR2_DAC1SHSEL_IGNORE")}
#define STM32_CFG_RNG_SEL                   ${doc.STM32_CFG_RNG_SEL!(doc.STM32_RNGSEL!"RCC_CCIPR2_RNGSEL_IGNORE")}
#define STM32_CFG_FDCAN1_SEL                ${doc.STM32_CFG_FDCAN1_SEL!(doc.STM32_FDCAN1SEL!"RCC_CCIPR1_FDCAN1SEL_SYSCLK")}
#define STM32_CFG_SAI1_SEL                  ${doc.STM32_CFG_SAI1_SEL!(doc.STM32_SAI1SEL!"RCC_CCIPR2_SAI1SEL_MSIK")}
#define STM32_CFG_ADF1_SEL                  ${doc.STM32_CFG_ADF1_SEL!(doc.STM32_ADF1SEL!"RCC_CCIPR2_ADF1SEL_HCLK")}
